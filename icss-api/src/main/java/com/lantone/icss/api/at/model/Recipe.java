...
public class Recipe implements Serializable{
	...
	//处方明细
	private List<RecipeDetailWrapper> listRecipeDetailWrapper=Lists.newArrayList();
	public String getId() {
		return id;
	}
	...
	public List<RecipeDetailWrapper> getListRecipeDetailWrapper() {
		return listRecipeDetailWrapper;
	}
	public void setListRecipeDetailWrapper(List<RecipeDetailWrapper> listRecipeDetailWrapper) {
