...
public class Examine implements Serializable{
	...
	//检查检验诊疗单明细
	private List<ExamineDetailWrapper> listExamineDetailWrapper=Lists.newArrayList();
	public String getID() {
		return ID;
	}
	...
	public Date getExaDate() {
		return exaDate;
	}
	public void setExaDate(Date exaDate) {
	...
	public List<ExamineDetailWrapper> getListExamineDetailWrapper() {
		return listExamineDetailWrapper;
	}
	public void setListExamineDetailWrapper(List<ExamineDetailWrapper> listExamineDetailWrapper) {
		this.listExamineDetailWrapper = listExamineDetailWrapper;
	}
