...
public class EtrackInterfaceSoapProxy implements com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoap {
  private String _endpoint = null;
  private com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoap etrackInterfaceSoap = null;
  ...
  private void _initEtrackInterfaceSoapProxy() {
    try {
      etrackInterfaceSoap = (new com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceLocator()).getEtrackInterfaceSoap();
  ...
  public com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoap getEtrackInterfaceSoap() {
    if (etrackInterfaceSoap == null)
      _initEtrackInterfaceSoapProxy();
