...
public class DutaDictResponseBody<T> implements java.io.Serializable{
	...
	private DutaDictResponse data=null;
	...
	public DutaDictResponse getData() {
		return data;
	}
	public void setData(DutaDictResponse data) {
		this.data = data;
	}
	public int getRet() {
		return ret;
