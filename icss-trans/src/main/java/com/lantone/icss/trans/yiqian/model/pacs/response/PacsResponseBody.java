...
public class PacsResponseBody<T> implements java.io.Serializable {
	...
	private PacsInfoResponse data = null;
	@XmlElement(name = "ret")
	...
	public PacsInfoResponse getData() {
		return data;
	}
	public void setData(PacsInfoResponse data) {
		this.data = data;
	}
