...
public class UseFrequencyResponseBody<T> implements java.io.Serializable{
	...
	private UseFrequencyResponse data=null;
	...
	public UseFrequencyResponse getData() {
		return data;
	}
	public void setData(UseFrequencyResponse data) {
		this.data = data;
	}
	public int getRet() {
		return ret;
