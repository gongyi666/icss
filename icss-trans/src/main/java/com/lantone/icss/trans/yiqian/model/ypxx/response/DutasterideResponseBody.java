...
public class DutasterideResponseBody<T> implements java.io.Serializable{
	...
	private DutasterideResponse data=null;
	...
	public DutasterideResponse getData() {
		return data;
	}
	public void setData(DutasterideResponse data) {
		this.data = data;
	}
	public int getRet() {
		return ret;
