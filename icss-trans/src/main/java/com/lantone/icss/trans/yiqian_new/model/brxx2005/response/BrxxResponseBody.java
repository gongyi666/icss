...
public class BrxxResponseBody<T> implements java.io.Serializable{
		...
		private BrxxResponseDetail data = null;
		...
		public BrxxResponseDetail getData() {
			return data;
		}
		public void setData(BrxxResponseDetail data) {
			this.data = data;
		}
