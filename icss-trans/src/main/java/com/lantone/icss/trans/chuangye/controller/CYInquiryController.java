...
import com.lantone.icss.trans.chuangye.service.CYInquiryService;
...
*/
@Controller
@RequestMapping("/chuangye/at")
public class CYInquiryController {
	
	private static Logger logger = LoggerFactory.getLogger(CYInquiryController.class);
	
	@Autowired
	CYInquiryService inquiryService;
