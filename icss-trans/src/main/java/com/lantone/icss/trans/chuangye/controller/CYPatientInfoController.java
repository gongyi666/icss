package com.lantone.icss.trans.chuangye.controller;
...
import com.lantone.icss.trans.chuangye.service.CYPatientInfoService;

@Controller
@RequestMapping("/chuangye/at/patient_info")
public class CYPatientInfoController {

	private static Logger logger = LoggerFactory.getLogger(CYPatientInfoController.class);
	
	@Autowired
	CYPatientInfoService service;
	//根据病人证号查询病人详细信息
