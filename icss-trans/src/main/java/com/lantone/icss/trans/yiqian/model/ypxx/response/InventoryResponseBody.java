 ...
 *	@author : CSP
 *	@time :2017年5月10日下午2:10:56
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "root")
public class InventoryResponseBody<T> implements java.io.Serializable{
	...
	private InventoryResponse data=null;
	...
	public InventoryResponse getData() {
		return data;
	}
	public void setData(InventoryResponse data) {
		this.data = data;
	}
	public int getRet() {
		return ret;
