...
public class EtrackInterfaceLocator extends org.apache.axis.client.Service implements com.lantone.icss.trans.yiqian.webservicetest.EtrackInterface {
    ...
    @Override
	public com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoap getEtrackInterfaceSoap() throws javax.xml.rpc.ServiceException {
    ...
    @Override
	public com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoap getEtrackInterfaceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoapStub _stub = new com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoapStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoapStub _stub = new com.lantone.icss.trans.yiqian.webservicetest.EtrackInterfaceSoapStub(new java.net.URL(EtrackInterfaceSoap_address), this);
                _stub.setPortName(getEtrackInterfaceSoapWSDDServiceName());
                return _stub;
            }
        }
