...
public class DiseaseInfoResponseBody<T> implements java.io.Serializable{
	...
	private DiseaseInfoResponse data=null;
	...
	public DiseaseInfoResponse getData() {
		return data;
	}
	public void setData(DiseaseInfoResponse data) {
		this.data = data;
	}
	public int getRet() {
		return ret;
