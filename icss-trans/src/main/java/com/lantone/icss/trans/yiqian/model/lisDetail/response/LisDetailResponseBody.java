...
public class LisDetailResponseBody<T> implements java.io.Serializable {
	...
	public LisDetailResponse getData() {
		return data;
	}
	public void setData(LisDetailResponse data) {
		this.data = data;
	}
	public int getRet() {
		return ret;
	...
	private LisDetailResponse data = null;
	@XmlElement(name = "ret")
