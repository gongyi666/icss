...
public class DeptInfoResponseBody<T> implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public DeptInfoResponse getData() {
		return data;
	}
	public void setData(DeptInfoResponse data) {
		this.data = data;
	}
	public int getRet() {
		return ret;
	...
	private DeptInfoResponse data = null;
	@XmlElement(name = "ret")
