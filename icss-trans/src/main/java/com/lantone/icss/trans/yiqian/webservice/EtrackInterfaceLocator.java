...
public class EtrackInterfaceLocator extends org.apache.axis.client.Service implements com.lantone.icss.trans.yiqian.webservice.EtrackInterface {
    ...
    private java.lang.String EtrackInterfaceSoap_address = "http://192.168.3.157:8081/EtrackInterface.asmx";
    ...
    @Override
	public com.lantone.icss.trans.yiqian.webservice.EtrackInterfaceSoap getEtrackInterfaceSoap() throws javax.xml.rpc.ServiceException {
    ...
    @Override
	public com.lantone.icss.trans.yiqian.webservice.EtrackInterfaceSoap getEtrackInterfaceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.lantone.icss.trans.yiqian.webservice.EtrackInterfaceSoapStub _stub = new com.lantone.icss.trans.yiqian.webservice.EtrackInterfaceSoapStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lantone.icss.trans.yiqian.webservice.EtrackInterfaceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.lantone.icss.trans.yiqian.webservice.EtrackInterfaceSoapStub _stub = new com.lantone.icss.trans.yiqian.webservice.EtrackInterfaceSoapStub(new java.net.URL(EtrackInterfaceSoap_address), this);
                _stub.setPortName(getEtrackInterfaceSoapWSDDServiceName());
                return _stub;
            }
        }
