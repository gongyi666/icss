...
public class DrugResponseBody implements java.io.Serializable {
	...
	public DrugInfoResponse getData() {
		return data;
	}
	public void setData(DrugInfoResponse data) {
		this.data = data;
	}
	public int getRet() {
		return ret;
