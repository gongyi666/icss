...
public interface PortraitInfoWithDiseaseMapper extends EntityMapper<PortraitInfo, PortraitInfoWithLisWrapper, Long>{
	 ...
	 */
	public List<PortraitInfoWithDiseaseWrapper> getPortraitWithDiseaseByTransverse(Long transverseId);
	 ...
	 */
	public List<PortraitInfoWithDiseaseWrapper> getPortraitWithDiseaseByParent(Long parentId);
}
