 ...
 */
@Controller
@RequestMapping("/subitem_rule_service")
public class SubitemRuleService {
	@Autowired
    private GetSubitemRuleService getSubitemRuleService;
	...
	* @throws
	...
	public IcssObjectOutput service(@RequestBody PageDataInput pageData, IcssObjectInput input, IcssObjectOutput output) {
        ...
        try{  
    		...
    		getSubitemRuleService.subitemRule(input, output);
