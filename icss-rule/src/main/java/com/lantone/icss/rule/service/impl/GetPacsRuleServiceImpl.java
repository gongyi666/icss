 ...
 */
@Service
public class GetPacsRuleServiceImpl implements GetPacsRuleService {
	@Resource(name = "ksession-lis-rules")
    private StatelessKnowledgeSession statelessKnowledgeSession;
	
	public void pacsRule(IcssObjectInput input, IcssObjectOutput output) {
