...
import com.lantone.icss.rule.service.GetPacsRuleService;
 ...
 */
@Controller
@RequestMapping("/pacs_rule_service")
public class PacsRuleService {
	@Autowired
    private GetPacsRuleService getPacsRuleService;
	...
	* @throws
	...
	public IcssObjectOutput service(@RequestBody PageDataInput pageData, IcssObjectInput input, IcssObjectOutput output) {
        ...
        try{  
    		...
    		getPacsRuleService.pacsRule(input, output);
	...
	public static void main(String[] args) {
        ...
        try{  
        	complaints = mapper.readValue(symptom, new TypeReference<HashMap<String, Object>>(){});
     	    chiefComplaint.setComplaints(new PacsRuleService().objectToMap((Map<String,Object>)complaints.get("SYMPTOM")));
     	    input.setChiefComplaint(chiefComplaint);
